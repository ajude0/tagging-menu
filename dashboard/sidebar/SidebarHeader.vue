<template>
  <div class="bg-gray-250 py-6">
    <!-- <svg width="35" height="30" viewBox="0 0 256 366" preserveAspectRatio="xMidYMid">
      <defs>
        <linearGradient id="linearGradient-1" x1="12.5189534%" y1="85.2128611%" x2="88.2282959%" y2="10.0225497%">
